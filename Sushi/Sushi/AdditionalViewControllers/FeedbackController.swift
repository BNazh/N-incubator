...
class FeedbackController: UIViewController {
    ...
    lazy var textLabel:UILabel = {
        ...
        text.textColor = #colorLiteral(red: 0.7540688515, green: 0.7540867925, blue: 0.7540771365, alpha: 1)
        text.font = UIFont(name: "Helvetica", size: 19)
        return text
    }()
    ...
    lazy var shareButton: CustomPressableButton = {
        ...
        label.backgroundColor = #colorLiteral(red: 1, green: 0.4431372549, blue: 0, alpha: 1)
    ...
    func setupConstrain(){
        constrain(viewPart,nameLabel,surnameLabel,emailLabel,telefoneLabel,textLabel,rateView,reviewLabel,viewPartOtziv,pickerView){part,name,surname,email,telefone,text,rate,review,PartOtziv,picker in
            ...
            part.height == (part.superview?.height)!/3.3
        ...
        constrain(viewPartOtziv,shareButton,nameLabel,image){PartOtziv,share,name,image in
            ...
            image.trailing == image.superview!.trailing - 10
            image.width == 40
            image.height == 40
    ...
    func setupViews(){
        ...
        self.pickerView.addSubview(image)
    }
}
