...
public class GameOfLife extends Application {
	...
	//Change this to the width/height of the world
	private int size = 1000;
	
	//Change this to the width/height of one cell (only rendering)
...
//				}
		...
		canvas.setOnMouseClicked((e) -> {
			...
			if (e.getButton() == MouseButton.PRIMARY) {
				...
				setState(x - 1, y - 1, ran.nextBoolean());
				setState(x, y - 1, ran.nextBoolean());
				setState(x + 1, y - 1, ran.nextBoolean());
				setState(x - 1, y, ran.nextBoolean());
				setState(x + 1, y, ran.nextBoolean());
				setState(x - 1, y + 1, ran.nextBoolean());
				setState(x, y + 1, ran.nextBoolean());
				setState(x + 1, y + 1, ran.nextBoolean());
